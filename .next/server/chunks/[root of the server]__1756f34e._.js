...
"[project]/.next-internal/server/app/api/manga/[id]/follow/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/manga/[id]/follow/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(_, { params }) {
    ...
    const follow = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].follow.findUnique({
        where: {
            userId_mangaId: {
                userId,
                mangaId: id
...
async function POST(_, { params }) {
    ...
    const userId = session.user.id;
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].follow.findUnique({
        where: {
            userId_mangaId: {
                userId,
                mangaId: id
    ...
    if (existing) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].follow.delete({
            where: {
                userId_mangaId: {
                    userId,
                    mangaId: id
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].follow.create({
            data: {
                userId,
                mangaId: id
            }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1756f34e._.js.map