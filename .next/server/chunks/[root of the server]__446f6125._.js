...
"[project]/.next-internal/server/app/api/manga/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/manga/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    try {
        ...
        const avgRating = manga.ratings.length > 0 ? manga.ratings.reduce((sum, r)=>sum + r.score, 0) / manga.ratings.length : 0;
        const result = {
            id: manga.id,
            title: manga.title,
...
async function PATCH(req, { params }) {
    try {
        ...
        const { title, description, coverImage, coverPositionX, coverPositionY, genre, status } = body;
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].manga.findUnique({
            where: {
                id
            },
            select: {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].manga.update({
            where: {
                id
            },
            data: {
        ...
        const avgRating = updated.ratings.length > 0 ? updated.ratings.reduce((sum, r)=>sum + r.score, 0) / updated.ratings.length : 0;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            id: updated.id,
            title: updated.title,
...
async function DELETE(_req, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].manga.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__446f6125._.js.map