...
"[project]/.next-internal/server/app/api/manga/[id]/chapters/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/manga/[id]/chapters/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(_, { params }) {
    ...
    const chapters = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].chapter.findMany({
        where: {
            mangaId: id
        },
        orderBy: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(chapters);
}
async function POST(req, { params }) {
    ...
    const manga = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].manga.findUnique({
        where: {
            id
        }
    });
    if (!manga) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Không tìm thấy manga"
    }, {
        status: 404
    });
    const { title, chapterNum, pages } = await req.json();
    const chapter = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].chapter.create({
        data: {
            title,
            chapterNum,
            pages,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(chapter, {
        status: 201
    });
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4ef6deef._.js.map