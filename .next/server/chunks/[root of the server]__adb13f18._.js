...
"[project]/.next-internal/server/app/api/manga/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/manga/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const [mangas, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].manga.findMany({
                where,
                include: {
                    author: {
                        select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].manga.count({
                where
            })
        ]);
        const result = mangas.map((m)=>{
            const avgRating = m.ratings.length > 0 ? m.ratings.reduce((sum, r)=>sum + r.score, 0) / m.ratings.length : 0;
            return {
                id: m.id,
                title: m.title,
...
async function POST(req) {
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].manga.create({
            data: {
                title: String(title).trim(),
                description: description ? String(description).trim() : "",
                coverImage: coverImage || null,
                coverPositionX: coverPositionX !== undefined ? Number(coverPositionX) : 50,
                coverPositionY: coverPositionY !== undefined ? Number(coverPositionY) : 50,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__adb13f18._.js.map