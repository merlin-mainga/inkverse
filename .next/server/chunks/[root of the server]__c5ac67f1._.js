...
"[project]/.next-internal/server/app/api/history/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function POST(req) {
    ...
    const history = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].readHistory.upsert({
        where: {
            userId_mangaId: {
                userId,
                mangaId
...
async function GET(req) {
    ...
    const userId = session.user.id;
    const history = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].readHistory.findMany({
        where: {
            userId
        },
        include: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c5ac67f1._.js.map