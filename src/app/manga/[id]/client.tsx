    ...
    <div style={S.root}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .glow-btn:hover:not(:disabled) { box-shadow: 0 0 20px rgba(201,65,30,0.4); transform: translateY(-1px); }
      ...
      <div style={S.container}>
        ...
        <div style={S.card} className="fade-up">
          ...
          {!session ? (
            <p style={S.dimText}>
              <span style={{ color: "#c9411e", cursor: "pointer" }} onClick={() => router.push("/login")}>Đăng nhập</span> để đánh giá
            </p>
          ) : ratingDone ? (
            <p style={{ fontFamily: "'Noto Sans',sans-serif", fontSize: 14, color: "#f5a623" }}>✅ Bạn đã đánh giá {userRating}/5 — cảm ơn!</p>
          ) : (
...
const S: Record<string, React.CSSProperties> = {
  ...
  plainBtn:     { marginTop: 12, padding: "8px 20px", background: "rgba(201,65,30,0.1)", border: "1px solid rgba(201,65,30,0.2)", borderRadius: 8, color: "#c9411e", cursor: "pointer", fontFamily: "'Noto Sans',sans-serif", fontSize: 13 },
  ...
  navBack:      { fontFamily: "'Noto Sans',sans-serif", fontSize: 13, color: "rgba(232,224,212,0.5)", cursor: "pointer", transition: "color 0.2s", whiteSpace: "nowrap" },
  navDivider:   { width: 1, height: 20, background: "rgba(255,255,255,0.1)", flexShrink: 0 },
  navTitle:     { fontFamily: "'Noto Sans',sans-serif", fontSize: 13, color: "rgba(232,224,212,0.7)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  ...
  statsRow:     { display: "flex", gap: 20, marginBottom: 20, flexWrap: "wrap" },
  stat:         { textAlign: "center" },
  statVal:      { fontFamily: "'Oswald',sans-serif", fontSize: 16, color: "#c9411e" },
  ...
  secondaryBtn: { padding: "10px 20px", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 8, color: "#e8e0d4", fontFamily: "'Noto Sans',sans-serif", fontSize: 14, fontWeight: 600, cursor: "pointer" },
  ...
  textarea:     { width: "100%", padding: "10px 14px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 6, color: "#e8e0d4", fontFamily: "'Noto Sans',sans-serif", fontSize: 14, resize: "none" },
